BizeoEthernet
Requires an arduino, the arduino 1.0 or later software, and an ethernet shield.
Interfaces to the bizeo web services through http calls.


Installation
--------------------------------------------------------------------------------
Copy all files into the folder: "<Arduino-Sketchbook>/libraries/BizeoEthernet"
Default sketch folder location is in:
...
Usage
--------------------------------------------------------------------------------
This library takes away all the hassle of work with the bizeo SOAP services
